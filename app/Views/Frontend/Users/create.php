<div class="px-4 py-6 sm:px-0">
    <div class="rounded-lg bg-white p-6 shadow-sm">
        <div class="border-b border-gray-200 pb-5">
            ...
            <p class="mt-2 text-sm text-gray-500">Fill in the form below to create a new user account</p>
        </div>
        
        <form class="mt-6 space-y-6" action="<?= base_url('admin/users/create') ?>" method="POST">
            <?= csrf_field() ?>
