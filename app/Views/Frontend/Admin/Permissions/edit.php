<div class="px-4 py-6 sm:px-0">
    <div class="rounded-lg bg-white p-6 shadow-sm">
        <div class="border-b border-gray-200 pb-5">
            ...
            <p class="mt-2 text-sm text-gray-500">Update the permission details</p>
        </div>
        
        <form class="mt-6 space-y-6" action="<?= base_url('admin/permissions/edit/' . $permission['id']) ?>" method="POST">
            <?= csrf_field() ?>
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-1">
                        <textarea id="description" name="description" rows="3"
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?= old('description', $permission['description']) ?></textarea>
                    </div>
                </div>
            </div>
